...
| ------------------- | ---------------------- | ------------------------------------ | ------------- | --------------------------------------------------------------------------- |
| **Data Demografis** | `age`                  | Usia pasien                          | Integer       | Input langsung (dalam tahun)                                                |
...
|                     | `avg_glucose_level`    | Rata-rata kadar gula darah           | Float         | Dalam mg/dL – diperoleh dari hasil tes darah                                |
|                     | `bmi`                  | Body Mass Index (Indeks Massa Tubuh) | Float         | Dalam kg/m² – bisa dihitung dari tinggi dan berat badan                     |
